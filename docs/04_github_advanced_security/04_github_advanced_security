...
In this exercise, you will configure GitHub Advanced Security features and enable code quality gates, security code reviews and leverage features such as automatic Pull Requests to support developer productivity and awareness. 
